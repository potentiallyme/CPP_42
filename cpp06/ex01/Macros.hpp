...
#define CHAROF std::cout<<YELLOW"char: "RED"overflow"RESET<<std::endl;
#define INT std::cout<<YELLOW"int: "RESET<<i<<std::endl;
#define INTOF std::cout<<YELLOW"int: "RESET<<"overflow"<<std::endl;
#define FLOAT std::cout<<YELLOW"float: "RESET<<std::fixed<<std::setprecision(1)<<f<<"f"<<std::endl;
#define FLOATS(len) std::cout<<YELLOW"float: "RESET<<std::fixed<<std::setprecision(len)<<f<<"f"<<std::endl;
